...
*/
void GridManager3D::DefaultInitializationDims(const DefSizet max_level) {
    k0GridDims_ = 3;
    k0IntOffest_ = {1, 1, 1};
    k0ZIntExtendPositive_ = std::vector<DefLUint>(max_level + 1, 0);
    k0ZIntExtendNegative_ = std::vector<DefLUint>(max_level + 1, 0);
    k0NumNeighbours_ = 27;
}
/**
...
void GridManager3D::SetGridParameters() {
    ...
    k0MaxIndexOfBackgroundNode_ = {
        ...
        / k0DomainDx_[kZIndex]) + k0IntOffest_[kZIndex] };
    ...
    k0RealOffest_[kZIndex] = k0IntOffest_[kZIndex] * k0DomainDx_[kZIndex];
